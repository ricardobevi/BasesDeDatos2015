...
SELECT nombre,(precio*100) AS precio_cents FROM producto;
...
SELECT producto.nombre, producto.precio, fabricante.nombre FROM producto JOIN fabricante ON fabricante.id=producto.id_fabricante;
