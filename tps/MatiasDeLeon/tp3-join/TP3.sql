...
FROM 	usuario_grupo
		JOIN usuario ON usuario.id = usuario_grupo.usuario_id
		WHERE usuario.telefono = 'tel';
...
FROM 	mensaje
		JOIN usuario ON usuario.id = mensaje.id_usr_from or mensaje.id_usr_to = usuario.id
		WHERE usuario.telefono = 'tel';
